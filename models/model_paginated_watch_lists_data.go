...
// checks if the PaginatedWatchListsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedWatchListsData{}
...
func NewNullablePaginatedWatchListsData(val *PaginatedWatchListsData) *NullablePaginatedWatchListsData {
	return &NullablePaginatedWatchListsData{value: val, isSet: true}
}
